    ...
    render() {
        return (
            <div className="death-container intro-container text-base container mx-auto animated-border border-solid border-2 border-teal-400 p-12">
                ...
                <div>
                    <p className="text-teal-400 mb-4">Code by <a href="https://www.linkedin.com/in/yorgoskakavas">Yorgos Kakavas</a>. Source code repository <a href="https://github.com/Falenos/interface">here</a></p><br/>
                </div>
